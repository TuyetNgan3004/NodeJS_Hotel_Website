    ...
    customer.save(function (err, result) {
        Customer.findById(result.id).populate('roomID')
            ...
            .exec(function (err, r) {
                ...
                console.log(typeof customers.c_checkout)
                let checkinDate = customers.c_checkin.toLocaleDateString('en-GB');
                ...
                let checkoutDate = customers.c_checkout.toLocaleDateString('en-GB');
                res.render('TabRoomsClient/showBookingSuccess',{ layout: 'mainClient.hbs', 
                customers: customers, checkinDate: checkinDate, checkoutDate: checkoutDate});
            })
    });
}
