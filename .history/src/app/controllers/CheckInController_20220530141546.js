...
const storeTaoPhieu = async (req, res, next) => {
...
module.exports = { showCheckIn, showCheckInBooking, showCheckInList, taophieu, store, edit, update, showDetail, updateBill, storeTaoPhieu};
