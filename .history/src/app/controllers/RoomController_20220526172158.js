    ...
    customer.save(function (err, result) {
        Customer.findById(result.id).populate('roomID')
            ...
            .exec(function (err, r) {
                ...
                let checkinDate = r.c_checkin.toLocaleDateString('en-GB');
                let checkoutDate = r.c_checkout.toLocaleDateString('en-GB');
                res.render('TabRoomsClient/showBookingSuccess',{ layout: 'mainClient.hbs', 
                customers: mongooseToObject(r), checkinDate: checkinDate, checkoutDate: checkoutDate});
            })
    });
}
