...
add_btn.forEach(btn => {
	btn.addEventListener('click', function(e) {
		...
		var sv_name = service.querySelector('.sv_name');
		console.log(sersv_namevice);
		var sv_type = service.getElementsByClassName('sv_type')[0].innerText;
		var sv_price = service.getElementsByClassName('sv_price')[0].innerText;
