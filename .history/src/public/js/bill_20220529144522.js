...
function AddSerive(name, type, price) {
	...
	serviceContent += `
		...
		<td class="price">
			${price}
			<input hidden type="text" name="sv_type" value="${price}">
		</td>
		<td class="sv-qty"><input class="qty-input" type="number" min="1" value="1" name="qty" id=""></td>
		<td class="sv-total">
			${result}
			<input hidden type="text" name="sv_type" value="${result}">
		</td>
		<td style="min-width: 0;">
			<div class="status-btn-circle service-remove"> <i class="fas fa-minus"></i></div>
		</td>
