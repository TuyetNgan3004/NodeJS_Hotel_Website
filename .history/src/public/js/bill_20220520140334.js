...
// CHECK ONCHANGE INPUT OF TABLE SERVICE
var serviceContainer = document.querySelector('#service-container').addEventListener('onchange', function() {
	var tb_service_qty = serviceContainer.querySelectorAll('.sv-qty .qty-input');
	console.log(tb_service_qty)
})
